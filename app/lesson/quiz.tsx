...
export const Quiz = ({
    ...
    const onContinue = () => {
        ...
        if (correctOption.id === selectedOption) { // May need to delete  correctOption &&, no info in the original code
            startTransition(() => {
            ...
            <>
                ...
                <div className="flex flex-col gap-y-4 lg:gap-y-8 max-w-lg mx-auto text-center items-center  justify-center h-full">
                    ...
                    <Image src="/finished.svg"
                        ...
                        height={50}
                        width={50} />
                    <h1 className="text-xl lg:text-3xl font-bold text-neutral-700">Great Job!
                        <br />
